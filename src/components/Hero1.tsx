        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-white space-y-6">
            ...
            <p className="text-white/80 max-w-md">
              We have a fresh selection of products at an amazing price. Explore
              our new arrivals.
            </p>
            <div className="flex items-center gap-4">
              <div className="text-2xl md:text-3xl font-bold">$16.45</div>
              <button
                className="bg-green-500 text-white px-6 py-2 rounded-md font-medium hover:bg-green-700
